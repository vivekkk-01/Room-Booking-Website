...
const BookingPlace = ({ place }) => {
  ...
  return (
    <Link
      to={place._id}
      className="bookingPlace grid grid-cols-[1fr_2fr] my-4 rounded-2xl bg-gray-300 gap-5"
    >
      <div className="w-50 h-32 overflow-hidden">
        <img
      ...
      <div className="bookingPlace-info flex-col justify-center items-center my-auto">
        <div>
          <h2 className="text-xl font-bold">{place.place.title}</h2>
        </div>
